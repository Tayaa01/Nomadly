...
class _TravelFormScreenState extends State<TravelFormScreen> {
  ...
  final DateTime _sessionDateTime = DateTime.utc(2025, 03, 09, 02, 34, 10);  // Updated timestamp
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          for (int i = 0; i < _getItineraryDays(chatProvider.lastGeneratedItinerary!).length; i++)
                            ElevatedButton(
                              onPressed: () => setState(() {
                                _selectedDayIndex = i;
                              }),
  ...
  void _generatePlan() async {
    ...
    try {
      final request = TravelRequest(
        ...
        startDate: _selectedDate!,  // Include start date
      );
