...
class _SpeechToTextViewState extends State<SpeechToTextView>
  ...
  Future<void> _loadDiscussions() async {
    try {
      ...
      print(
        'Checking for "discussions" key: ${_prefs.containsKey('discussions')}',
      );

      final discussionsJson = _prefs.getStringList('discussions') ?? [];
      print(
        'Loading ${discussionsJson.length} discussions from SharedPreferences',
      );
  ...
  Future<void> _saveDiscussions() async {
    try {
      ...
      print(
        'Saving ${discussionsJson.length} discussions to SharedPreferences',
      );
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      PredefinedPhrases.categoryIcons[_currentDiscussion!
                              .category] ??
                          Icons.label_outline,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.translate, size: 64, color: Colors.grey[400]),
          ),
  ...
  Widget _buildStyledDiscussionItem(Discussion discussion) {
    ...
    final hoursLeft =
        discussion.isFavorite
            ? null
            : 24 - DateTime.now().difference(discussion.createdAt).inHours;
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      createNew
                          ? 'Select Category for New Discussion'
                          : 'Change Category',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                ...
                Flexible(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isTtsSupported = _supportedTtsLanguages.contains(
                        language['code'],
                      );
